...
const projectDetails={
  ...
  'Rental Analytics':['Rental signals were fragmented across operational data.','Created a modeled SQL, BigQuery, and Looker decision layer, orchestrated end-to-end by an Airflow pipeline with scheduling, retries, task groups, callbacks, and environment-specific configuration.'],
